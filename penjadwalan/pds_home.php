...
<head>
    ...
    <title>GITJ Ngablak - Persekutuan Doa Senin</title>
...
<?php require 'komponen/header.php'; ?>
    ...
    <div class="container">
      <div class="mb-3">
        <p>
            ...
            title="Petunjuk"
            data-mdb-content="
            Jadwal sementara untuk Persekutuan Doa Senin, menunggu pembaruan jadwal berikutnya"> Petunjuk pemakaian
            </a>
        </p>
      </div>
    </div>
  ...
  <main class="my-2">
    ...
    <div class="container">
      ...
      <!--Section: Content-->
      <section class="mb-6">
        <h4>Persekutuan Doa Senin</h4>
        <p>Tampilan Sementara.. Menunggu pembaruan sistem penjadwalan</p>
        <div class="text-center">
            <img src="../img/persekutuan doa senin.png" alt="jadwal brayatan pepanthan">
        </div>
      </section>
      <!--Section: Content-->
    </div>
