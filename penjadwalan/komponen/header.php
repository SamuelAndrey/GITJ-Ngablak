        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <li>
                <a class="dropdown-item" href="ngm_home.php">Ibadah Minggu Ngablak</a>
              </li>
              <li>
                <a class="dropdown-item" href="pm_home.php">Ibd Minggu Ngablak & Pepanthan</a>
              </li>
              <li>
                <a class="dropdown-item" href="brn_home.php">Brayatan Ngablak</a>
              </li>
              <li>
                <a class="dropdown-item" href="brp_home.php">Brayatan Pepanthan</a>
              </li>
              <li>
                <a class="dropdown-item" href="pds_home.php">Persekutuan Doa Senin</a>
              </li>
            </ul>
          </li>
          <!-- dropdown jadwal ibadah -->
